...
<body>
    <header class="hero">
        <div class="container">
            <nav class="nav">
                <a href="index.php" class="nav__items">Inicio</a>
            ...
            <section class="hero__container">
                <div class="hero__texts">
                    <h1 class="hero__title">Comienza a trabajar con sell well</h1>
                    <h2 class="hero__subtitle">Acercate a tus clientes</h2>
                    <a href="registro.php" class="hero__cta">Registrate ahora</a>
                </div>
            </section>
        </div>
    ...
    <main>
        ...
        <section class="about container">
            ...
            <div class="about__texts">
                <h2 class="subtitle">¿Porque tener una pagina Web?</h2>
                <p class="about__paragraph">El tener una web te brinda la oportunidad de estar en contacto constante con tus clientes, que pueden consultarte en cualquier momento o ver tus productos y servicios</p>
